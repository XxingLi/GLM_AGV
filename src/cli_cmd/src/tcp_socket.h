...
#define EXPLENTH 13                     //探索模式长度
#define TELLENTH 4                      //远程模式长度
#define PXPOSESTR 2                     //探索模式命令开始位置
#define PYPOSEEND 9                     //探索模式命令结束位置
#define SCEXPHEAD 0x41                  //SC探索模式数据头
#define SCEXPSTR 0x4e                   //SC探索模式开始命令
#define SCEXPEND 0x4f                   //SC探索模式停止命令
#define SCTELHEAD 0x31                  //SC远程模式数据头
#define SCTELSTR 0x3e                   //SC远程模式开始命令
#define SCTELEND 0X3f                   //command of stop the telnet mode in SC
#define START 0x6e                      //command of start at data fram
#define END 0x6f
#define DOING 0x0f
#define DO 0x0e
